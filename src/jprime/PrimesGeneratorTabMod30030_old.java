 ...
 */
public class PrimesGeneratorTabMod30030_old
{
    ...
    private static final short LAST_ELT = TAB_ELTS[NB_BITS - 1];
    ...
    public static long[] generateTab(long nMax)
    {
        ...
        tab[0] = 0x00_00_00_00_00_00_00_01L;   //only 1 is not prime (PS: not in 30030. 17*17,17*19, 19*19 ...97*293 ...)
...
//            System.out.println(Arrays.toString(cacheMultDiv30));
    ...
    private static void loop1To30029(final long[] tab, final long nMax, final int size, final short[] cacheMultDiv30030, final short[] cacheBitShift)
    {
        ...
        for (int ib = 1; ib < NB_BITS; ib++)
        {
            ...
            final long bitsAnd1 = 0b1L << iShiftV1;
...
//                    int ibShift = Arrays.binarySearch(TAB_ELTS, mod);   //Too Slow (500 ms)
                ...
                final long bitsAnd17to30013 = 0b1L << iShift17to30013;
                ...
                if (ib != jb)
                {
                    ...
                    final long bitsAndV2 = 0b1L << iShiftV2;
            ...
            final long bitsAnd30029 = 0b1L << iShift30029;
            ...
            final short[] cacheMultDiv30030, final short[] cacheBitShift)
    {
        ...
        for (int iBlock = 1; iBlock < nbBlocks; iBlock++)
        {
            ...
            final boolean isV1Prime30031 = (bits1 & 0b1L) == 0b0;
            for (int jb = 0; jb < NB_BITS; jb++)
            {
                final int jLong = jb >>> 6;
                final int jShift = jb & 0b11_1111;
                final long bitsAnd30031With1to30029 = 0b1L << jShift;
            ...
            for (int ib = 1; ib < NB_BITS; ib++)
            {
                ...
                final long bitsAndV1 = 0b1L << iShift;
                ...
                final long bitsAnd60059 = 0b1L << iShift60059;
                ...
                if (ib != NB_BITS - 1)
                {
                    final boolean isV2Prime = (tab[iBlock * (NB_LONG + 1) - 1] & 0b1L << 63) == 0b0;
                    if (isV2Prime)
                    {
